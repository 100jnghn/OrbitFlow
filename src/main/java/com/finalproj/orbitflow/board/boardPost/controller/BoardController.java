...
public class BoardController {
        ...
        public ResponseEntity<ResponseDto> getBoardList(
                ...
                Page<BoardResDto.ListInfo> result = boardService.getBoardList(
                                user.getCompanyId(),
        ...
        public ResponseEntity<ResponseDto> getBoardDetail(
                ...
                BoardResDto.DetailInfo detail = boardService.getBoardDetail(
                                user.getCompanyId(),
        ...
        public ResponseEntity<ResponseDto<BoardResDto.DetailInfo>> createBoard(
                ...
                BoardResDto.DetailInfo response = boardService.createBoard(
                                user.getCompanyId(),
                                user.getOrganizationId(),
                                user.getEmployeeId(),
                                request,
