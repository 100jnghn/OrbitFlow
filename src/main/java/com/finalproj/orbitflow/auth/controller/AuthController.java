...
public class AuthController {
        ...
        public ResponseEntity<ResponseDto> refresh(
                ...
                SecurityUser user = userDetailsService.loadByEmployeeId(refreshToken.getEmployeeId());
        ...
        public ResponseEntity<ResponseDto> extendSession(
                ...
                SecurityUser user = userDetailsService.loadByEmployeeId(oldToken.getEmployeeId());
