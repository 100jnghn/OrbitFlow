...
public class MessageController {
    ...
    public ResponseEntity<ResponseDto<Page<MessageResDto.ListItem>>> getMessageList(
            ...
            @RequestParam MessageFolderType folder,
            Pageable pageable
    ) {
        Page<MessageResDto.ListItem> result =
        ...
        return ResponseEntity.ok(
                new ResponseDto<>(HttpStatus.OK, "메시지 목록 조회 성공", result)
        );
    }
    ...
    public ResponseEntity<ResponseDto<MessageResDto.Detail>> getMessageDetail(
        ...
        return ResponseEntity.ok(
                new ResponseDto<>(HttpStatus.OK, "메시지 상세 조회 성공", result)
        );
    }
