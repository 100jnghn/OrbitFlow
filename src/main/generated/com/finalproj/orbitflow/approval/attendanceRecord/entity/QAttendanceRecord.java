...
public class QAttendanceRecord extends EntityPathBase<AttendanceRecord> {
    ...
    public final com.finalproj.orbitflow.leave.leaveType.entity.QLeaveType leaveType;
    ...
    public QAttendanceRecord(Class<? extends AttendanceRecord> type, PathMetadata metadata, PathInits inits) {
        ...
        this.leaveType = inits.isInitialized("leaveType") ? new com.finalproj.orbitflow.leave.leaveType.entity.QLeaveType(forProperty("leaveType")) : null;
