...
INSERT INTO leave_type (type_name, is_countable, description, created_at, updated_at) VALUES
-- [연차 차감 항목]
('연차', 1, '근로기준법에 따른 정기 유급휴가 (1일 단위)', NOW(), NOW()),
('오전반차', 1, '오전 근무 후 14시 퇴근 (0.5일 차감)', NOW(), NOW()),
('오후반차', 1, '14시 출근 후 오후 근무 (0.5일 차감)', NOW(), NOW()),
('반반차', 1, '2시간 단위 유급휴가 (0.25일 차감)', NOW(), NOW()),
('보상휴가', 1, '연장근로 보상으로 발생한 대체 휴가', NOW(), NOW()),

-- [비차감 항목]
('경조휴가', 0, '본인 및 가족 경조사 관련 유급휴가', NOW(), NOW()),
('병가', 0, '업무 외 질병/부상 치료를 위한 휴가', NOW(), NOW()),
('포상휴가', 0, '우수 성과자 등에게 부여되는 특별 유급휴가', NOW(), NOW()),
('공가', 0, '예비군, 투표 등 공적 의무 수행을 위한 휴가', NOW(), NOW()),
('하계휴가', 0, '회사에서 별도로 부여하는 하절기 특별 휴가', NOW(), NOW()),
('가족돌봄휴가', 0, '가족의 질병, 사고, 양육을 위한 긴급 휴가 (무급 원칙)', NOW(), NOW());
...
INSERT INTO attendance_record (employee_id, company_id, start_date, end_date, days, type_id, reason, status, created_at, updated_at) VALUES
...
VALUES (1, 10, '2025-11-03', '2025-11-03 08:52:00', '2025-11-03 18:05:00', 'ON_TIME', 1, 0),
       ...
       (1, 1, '2025-12-26', '2025-12-26 08:55:20', '2025-12-26 18:05:10', 'ON_TIME', 1,0),
       (1, 1, '2025-12-24', '2025-12-24 08:50:00', '2025-12-24 18:10:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-23', '2025-12-23 09:15:30', '2025-12-23 18:02:40', 'LATE', 1,0),
       (1, 1, '2025-12-22', '2025-12-22 08:45:10', '2025-12-22 18:30:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-19', '2025-12-19 08:58:00', '2025-12-19 18:05:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-17', '2025-12-17 08:59:10', '2025-12-17 18:15:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-16', '2025-12-16 09:10:00', '2025-12-16 18:05:00', 'LATE', 1,0),
       (1, 1, '2025-12-15', '2025-12-15 08:40:00', '2025-12-15 18:00:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-12', '2025-12-12 08:55:00', '2025-12-12 18:10:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-11', '2025-12-11 08:53:00', '2025-12-11 18:05:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-10', '2025-12-10 09:20:00', '2025-12-10 18:00:00', 'LATE', 1,0),
       (1, 1, '2025-12-09', '2025-12-09 08:50:00', '2025-12-09 18:05:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-08', '2025-12-08 08:45:00', '2025-12-08 18:20:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-05', '2025-12-05 08:58:20', '2025-12-05 18:05:40', 'ON_TIME', 1,0),
       (1, 1, '2025-12-04', '2025-12-04 08:52:00', '2025-12-04 18:10:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-02', '2025-12-02 08:50:30', '2025-12-02 18:05:00', 'ON_TIME', 1,0),
       (1, 1, '2025-12-01', '2025-12-01 08:59:00', '2025-12-01 18:10:00', 'ON_TIME', 1,0),
       (1, 1, '2025-11-28', '2025-11-28 08:50:00', '2025-11-28 18:05:00', 'ON_TIME', 1,0);
...
(86, 18, 45, 'Flight ticket deals update', 'Found discounted routes for Tokyo and Bangkok. Sharing links internally.', 47),
...
-- ==========================================
INSERT INTO message_recipient (company_id, message_id, employee_id, is_read, message_folder_type) VALUES
-- 회사 1 수신 데이터
(1, 1, 5, 0, 'INBOX'), (1, 2, 12, 1, 'INBOX'), (1, 3, 18, 0, 'INBOX'),
(1, 4, 1, 1, 'INBOX'), (1, 5, 11, 0, 'INBOX'), (1, 6, 20, 1, 'INBOX'),
(1, 7, 2, 0, 'INBOX'), (1, 8, 9, 1, 'INBOX'), (1, 9, 16, 0, 'INBOX'),
(1, 10, 3, 1, 'INBOX'), (1, 11, 8, 0, 'INBOX'), (1, 12, 14, 1, 'INBOX'),
(1, 13, 4, 0, 'INBOX'), (1, 14, 7, 1, 'INBOX'), (1, 15, 19, 0, 'INBOX'),
(1, 16, 10, 1, 'INBOX'), (1, 17, 13, 0, 'INBOX'), (1, 18, 1, 1, 'INBOX'),
(1, 19, 6, 0, 'INBOX'), (1, 20, 15, 1, 'INBOX'), (1, 21, 2, 0, 'INBOX'),
(1, 22, 5, 1, 'INBOX'), (1, 23, 17, 0, 'INBOX'), (1, 24, 3, 1, 'INBOX'),
(1, 25, 4, 0, 'INBOX'), (1, 26, 12, 1, 'INBOX'), (1, 27, 8, 0, 'INBOX'),
(1, 28, 9, 1, 'INBOX'), (1, 29, 14, 0, 'INBOX'), (1, 30, 20, 1, 'INBOX'),
(1, 31, 1, 0, 'INBOX'), (1, 32, 6, 1, 'INBOX'), (1, 33, 15, 0, 'INBOX'),
(1, 34, 2, 1, 'INBOX'), (1, 35, 7, 0, 'INBOX'), (1, 36, 11, 1, 'INBOX'),
(1, 37, 3, 0, 'INBOX'), (1, 38, 10, 1, 'INBOX'), (1, 39, 16, 0, 'INBOX'),
(1, 40, 4, 1, 'INBOX'), (1, 41, 13, 0, 'INBOX'), (1, 42, 17, 1, 'INBOX'),
(1, 43, 5, 0, 'INBOX'), (1, 44, 18, 1, 'INBOX'), (1, 45, 9, 0, 'INBOX'),
(1, 46, 6, 1, 'INBOX'), (1, 47, 14, 0, 'INBOX'), (1, 48, 12, 1, 'INBOX'),
(1, 49, 7, 0, 'INBOX'), (1, 50, 19, 1, 'INBOX'), (1, 51, 8, 0, 'INBOX'),
(1, 52, 8, 1, 'INBOX'), (1, 53, 1, 0, 'INBOX'), (1, 54, 15, 1, 'INBOX'),
(1, 55, 9, 0, 'INBOX'), (1, 56, 2, 1, 'INBOX'), (1, 57, 11, 0, 'INBOX'),
(1, 58, 10, 1, 'INBOX'), (1, 59, 3, 0, 'INBOX'), (1, 60, 4, 1, 'INBOX'),

-- 회사 2 수신 데이터
(2, 61, 30, 0, 'INBOX'), (2, 62, 35, 1, 'INBOX'), (2, 63, 25, 0, 'INBOX'),
(2, 64, 21, 1, 'INBOX'), (2, 65, 33, 0, 'INBOX'), (2, 66, 38, 1, 'INBOX'),
(2, 67, 22, 0, 'INBOX'), (2, 68, 29, 1, 'INBOX'), (2, 69, 36, 0, 'INBOX'),
(2, 70, 23, 1, 'INBOX'), (2, 71, 28, 0, 'INBOX'), (2, 72, 31, 1, 'INBOX'),
