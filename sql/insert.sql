...
('하계휴가', 0, '회사에서 별도로 부여하는 하절기 특별 휴가', 0.000, NOW(), board_permissionNOW()),
...
-- =========================================================
-- 2) 2025 사용 기록 20건 (차감/비차감 섞어서)
--    - status=APPROVED만 leave_balance 차감 반영되게 만들었음
-- =========================================================
...
(employee_id, company_id, start_date, end_date, days, type_id, reason, status, created_at, updated_at)
VALUES
-- [차감] 연차(1) / 반차(2,3) / 반반차(4) / 보상휴가(5)
(@EMPLOYEE_ID, @COMPANY_ID, '2025-01-15', '2025-01-15', 1.0 , 1, '연초 개인정비', 'APPROVED', '2025-01-10 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-02-14', '2025-02-14', 0.5 , 2, '은행업무(오전)', 'APPROVED', '2025-02-10 10:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-03-07', '2025-03-07', 0.5 , 3, '개인용무(오후)', 'REJECTED', '2025-03-05 11:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-04-02', '2025-04-02', 0.25, 4, '반반차(2시간)', 'APPROVED', '2025-04-01 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-04-18', '2025-04-18', 1.0 , 1, '리프레시', 'APPROVED', '2025-04-10 13:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-05-09', '2025-05-09', 1.0 , 1, '가정행사', 'APPROVED', '2025-05-01 09:30:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-06-20', '2025-06-20', 0.5 , 3, '오후 조기퇴근', 'REJECTED', '2025-06-18 11:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-07-03', '2025-07-03', 1.0 , 5, '보상휴가 사용', 'APPROVED', '2025-07-01 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-08-11', '2025-08-11', 1.0 , 1, '개인 휴식', 'APPROVED', '2025-08-01 10:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-09-19', '2025-09-19', 0.5 , 2, '오전 반차', 'APPROVED', '2025-09-10 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-10-24', '2025-10-24', 1.0 , 1, '이사', 'APPROVED', '2025-10-10 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-12-26', '2025-12-26', 1.0 , 1, '연말 휴식', 'APPROVED', '2025-12-10 14:00:00', NOW()),

-- [비차감] 경조(6) / 병가(7) / 포상(8) / 공가(9) / 하계(10) / 가족돌봄(11)
(@EMPLOYEE_ID, @COMPANY_ID, '2025-01-22', '2025-01-22', 1.0 , 9 , '공가(교육/훈련)', 'APPROVED', '2025-01-20 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-02-05', '2025-02-05', 1.0 , 7 , '병가', 'APPROVED', '2025-02-05 08:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-03-15', '2025-03-17', 3.0 , 6 , '경조휴가', 'APPROVED', '2025-03-01 11:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-05-01', '2025-05-01', 1.0 , 8 , '포상휴가', 'APPROVED', '2025-04-20 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-06-15', '2025-06-15', 1.0 , 9 , '공가(민방위)', 'APPROVED', '2025-06-01 09:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-07-20', '2025-07-24', 5.0 , 10, '하계휴가', 'APPROVED', '2025-07-01 10:00:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-11-05', '2025-11-07', 3.0 , 6 , '경조휴가(상례)', 'APPROVED', '2025-11-05 07:30:00', NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2025-12-29', '2025-12-29', 1.0 , 11, '가족돌봄휴가', 'APPROVED', '2025-12-28 17:00:00', NOW()),
-- [차감] 2026년 연차 데이터 (employee_id = 1, company_id = 1)
(@EMPLOYEE_ID, @COMPANY_ID, '2026-01-16', '2026-01-16', 1.0 , 1, '2026-01 연차', 'APPROVED', NOW(), NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2026-02-13', '2026-02-13', 0.5 , 2, '2026-02 오전반차', 'APPROVED', NOW(), NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2026-03-06', '2026-03-06', 0.5 , 3, '2026-03 오후반차', 'REJECTED', NOW(), NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2026-04-10', '2026-04-10', 0.25, 4, '2026-04 반반차', 'APPROVED', NOW(), NOW()),
(@EMPLOYEE_ID, @COMPANY_ID, '2026-06-19', '2026-06-19', 1.0 , 1, '2026-06 연차', 'APPROVED', NOW(), NOW()),

(2,1,'2026-01-08','2026-01-08',1.0,1,'EMP2-2026-01 연차','APPROVED',NOW(),NOW()),
(2,1,'2026-01-22','2026-01-22',0.5,2,'EMP2-2026-02 오전반차','APPROVED',NOW(),NOW()),
(2,1,'2026-02-12','2026-02-12',0.5,3,'EMP2-2026-03 오후반차','APPROVED',NOW(),NOW()),
(2,1,'2026-02-26','2026-02-26',0.25,4,'EMP2-2026-04 반반차','APPROVED',NOW(),NOW()),
(2,1,'2026-03-12','2026-03-12',1.0,1,'EMP2-2026-05 연차','APPROVED',NOW(),NOW()),
(2,1,'2026-03-26','2026-03-26',1.0,1,'EMP2-2026-06 연차','APPROVED',NOW(),NOW()),
(2,1,'2026-04-09','2026-04-09',0.5,2,'EMP2-2026-07 오전반차','APPROVED',NOW(),NOW()),
(2,1,'2026-04-23','2026-04-23',0.5,3,'EMP2-2026-08 오후반차','APPROVED',NOW(),NOW()),
(2,1,'2026-05-07','2026-05-07',1.0,5,'EMP2-2026-09 보상휴가','APPROVED',NOW(),NOW()),
(2,1,'2026-06-11','2026-06-11',1.0,1,'EMP2-2026-10 연차','APPROVED',NOW(),NOW()),
(2,1,'2026-09-24','2026-09-24',1.0,1,'EMP2-2026-11 연차','APPROVED',NOW(),NOW()),
(2,1,'2026-12-23','2026-12-23',1.0,1,'EMP2-2026-12 연차','APPROVED',NOW(),NOW()),

(2,1,'2026-01-20','2026-01-20',1.0,9 ,'EMP2-2026-13 공가','APPROVED',NOW(),NOW()),
(2,1,'2026-02-03','2026-02-03',1.0,7 ,'EMP2-2026-14 병가','APPROVED',NOW(),NOW()),
(2,1,'2026-03-16','2026-03-18',3.0,6 ,'EMP2-2026-15 경조','APPROVED',NOW(),NOW()),
(2,1,'2026-05-01','2026-05-01',1.0,8 ,'EMP2-2026-16 포상','APPROVED',NOW(),NOW()),
(2,1,'2026-06-14','2026-06-14',1.0,9 ,'EMP2-2026-17 공가','APPROVED',NOW(),NOW()),
(2,1,'2026-07-27','2026-07-31',5.0,10,'EMP2-2026-18 하계','APPROVED',NOW(),NOW()),
(2,1,'2026-11-06','2026-11-08',3.0,6 ,'EMP2-2026-19 경조','APPROVED',NOW(),NOW()),
(2,1,'2026-12-28','2026-12-28',1.0,11,'EMP2-2026-20 가족돌봄','APPROVED',NOW(),NOW());
...
SELECT
    e.id,
    e.company_id,
    DATE('2025-01-01') AS grant_date,
    CASE
        WHEN e.hire_date <= DATE_SUB(DATE('2025-01-01'), INTERVAL 1 YEAR) THEN
            LEAST(15 + FLOOR((TIMESTAMPDIFF(YEAR, e.hire_date, DATE('2025-01-01')) - 1) / 2), 25)
        ELSE
            ROUND((TIMESTAMPDIFF(MONTH, e.hire_date, DATE('2025-01-01')) / 12) * 15, 2)
        END AS granted_days,
    CASE
        WHEN e.hire_date <= DATE_SUB(DATE('2025-01-01'), INTERVAL 1 YEAR) THEN 'ANNUAL_REGULAR'
        ELSE 'ANNUAL_PROPORTIONAL'
        END AS grant_type,
    NOW()
FROM employee e
WHERE e.id = @EMPLOYEE_ID
  ...
  AND NOT EXISTS (
    SELECT 1 FROM grant_history gh
    WHERE gh.employee_id = e.id
      AND gh.company_id = e.company_id
      AND gh.grant_date = DATE('2025-01-01')
);
...
SELECT
    e.id,
    e.company_id,
    DATE('2026-01-01') AS grant_date,
    CASE
        WHEN e.hire_date <= DATE_SUB(DATE('2026-01-01'), INTERVAL 1 YEAR) THEN
            LEAST(15 + FLOOR((TIMESTAMPDIFF(YEAR, e.hire_date, DATE('2026-01-01')) - 1) / 2), 25)
        ELSE
            ROUND((TIMESTAMPDIFF(MONTH, e.hire_date, DATE('2026-01-01')) / 12) * 15, 2)
        END AS granted_days,
    CASE
        WHEN e.hire_date <= DATE_SUB(DATE('2026-01-01'), INTERVAL 1 YEAR) THEN 'ANNUAL_REGULAR'
        ELSE 'ANNUAL_PROPORTIONAL'
        END AS grant_type,
    NOW()
FROM employee e
WHERE e.id = @EMPLOYEE_ID
  ...
  AND NOT EXISTS (
    ...
    WHERE gh.employee_id = e.id
      AND gh.company_id = e.company_id
      AND gh.grant_date = DATE('2026-01-01')
);
...
-- 2025/2026 각각 total_granted / remaining 계산해서 UPSERT
INSERT INTO leave_balance (company_id, employee_id, year, total_granted, remaining_days)
SELECT
    @COMPANY_ID,
    @EMPLOYEE_ID,
    y.year,
    IFNULL(g.total_granted, 0) AS total_granted,
    ROUND(IFNULL(g.total_granted, 0) - IFNULL(u.used_days, 0), 2) AS remaining_days
FROM (
         SELECT 2025 AS year UNION ALL SELECT 2026
     ) y
         LEFT JOIN (
    SELECT YEAR(grant_date) AS year, SUM(granted_days) AS total_granted
    FROM grant_history
    WHERE company_id=@COMPANY_ID AND employee_id=@EMPLOYEE_ID
      AND YEAR(grant_date) IN (2025, 2026)
    GROUP BY YEAR(grant_date)
) g ON g.year = y.year
         LEFT JOIN (
    SELECT YEAR(ar.start_date) AS year, SUM(ar.days) AS used_days
    FROM attendance_record ar
             JOIN leave_type lt ON lt.id = ar.type_id
    WHERE ar.company_id=@COMPANY_ID AND ar.employee_id=@EMPLOYEE_ID
      AND ar.status='APPROVED'
      AND YEAR(ar.start_date) IN (2025, 2026)
      AND lt.is_countable=1
    GROUP BY YEAR(ar.start_date)
) u ON u.year = y.year
...
(company_id, employee_id, work_date, commute_at, leave_at, status, applied_rule_id, is_corrected, correction_reason)
VALUES
-- =========================
-- 2025 (총 50건 = 25일 * 2명)
-- =========================
(1,1,'2025-01-16','2025-01-16 08:55:00','2025-01-16 18:05:00','ON_TIME',1,0,NULL),
(1,2,'2025-01-16','2025-01-16 09:12:00','2025-01-16 18:20:00','LATE',1,0,NULL),

(1,1,'2025-01-20',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-01-20','2025-01-20 08:52:00','2025-01-20 18:10:00','ON_TIME',1,0,NULL),

(1,1,'2025-01-23','2025-01-23 09:06:00','2025-01-23 18:25:00','LATE',1,0,NULL),
(1,2,'2025-01-23','2025-01-23 08:57:00','2025-01-23 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2025-02-04','2025-02-04 08:49:00','2025-02-04 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2025-02-04','2025-02-04 09:15:00','2025-02-04 18:35:00','LATE',1,0,NULL),

(1,1,'2025-02-11',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-02-11','2025-02-11 08:55:00','2025-02-11 18:00:00','ON_TIME',1,0,NULL),

(1,1,'2025-02-18','2025-02-18 08:46:00','2025-02-18 18:05:00','ON_TIME',1,0,NULL),
(1,2,'2025-02-18','2025-02-18 09:08:00','2025-02-18 18:18:00','LATE',1,0,NULL),

(1,1,'2025-03-05','2025-03-05 09:10:00','2025-03-05 18:30:00','LATE',1,0,NULL),
(1,2,'2025-03-05','2025-03-05 08:50:00','2025-03-05 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2025-03-12','2025-03-12 08:45:00','2025-03-12 18:00:00','ON_TIME',1,0,NULL),
(1,2,'2025-03-12',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2025-03-19','2025-03-19 08:57:00','2025-03-19 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2025-03-19','2025-03-19 09:11:00','2025-03-19 18:28:00','LATE',1,0,NULL),

(1,1,'2025-04-03',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-04-03','2025-04-03 08:54:00','2025-04-03 18:06:00','ON_TIME',1,0,NULL),

(1,1,'2025-04-10','2025-04-10 09:07:00','2025-04-10 18:22:00','LATE',1,0,NULL),
(1,2,'2025-04-10','2025-04-10 08:55:00','2025-04-10 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2025-04-17','2025-04-17 08:52:00','2025-04-17 18:12:00','ON_TIME',1,0,NULL),
(1,2,'2025-04-17',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2025-05-08','2025-05-08 08:50:00','2025-05-08 18:00:00','ON_TIME',1,0,NULL),
(1,2,'2025-05-08','2025-05-08 09:18:00','2025-05-08 18:30:00','LATE',1,0,NULL),

(1,1,'2025-05-15','2025-05-15 09:05:00','2025-05-15 18:20:00','LATE',1,0,NULL),
(1,2,'2025-05-15','2025-05-15 08:52:00','2025-05-15 18:08:00','ON_TIME',1,0,NULL),

(1,1,'2025-06-05',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-06-05','2025-06-05 08:55:00','2025-06-05 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2025-06-12','2025-06-12 08:48:00','2025-06-12 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2025-06-12','2025-06-12 09:12:00','2025-06-12 18:25:00','LATE',1,0,NULL),

(1,1,'2025-06-19','2025-06-19 09:09:00','2025-06-19 18:22:00','LATE',1,0,NULL),
(1,2,'2025-06-19',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2025-07-03','2025-07-03 08:55:00','2025-07-03 18:05:00','ON_TIME',1,0,NULL),
(1,2,'2025-07-03','2025-07-03 08:58:00','2025-07-03 18:10:00','ON_TIME',1,0,NULL),

(1,1,'2025-07-10',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-07-10','2025-07-10 09:14:00','2025-07-10 18:28:00','LATE',1,0,NULL),

(1,1,'2025-08-07','2025-08-07 08:51:00','2025-08-07 18:06:00','ON_TIME',1,0,NULL),
(1,2,'2025-08-07',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2025-08-21','2025-08-21 09:08:00','2025-08-21 18:24:00','LATE',1,0,NULL),
(1,2,'2025-08-21','2025-08-21 08:54:00','2025-08-21 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2025-09-04','2025-09-04 08:50:00','2025-09-04 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2025-09-04','2025-09-04 09:09:00','2025-09-04 18:24:00','LATE',1,0,NULL),

(1,1,'2025-09-18',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-09-18','2025-09-18 08:58:00','2025-09-18 18:06:00','ON_TIME',1,0,NULL),

(1,1,'2025-10-02','2025-10-02 08:47:00','2025-10-02 18:03:00','ON_TIME',1,0,NULL),
(1,2,'2025-10-02','2025-10-02 09:16:00','2025-10-02 18:30:00','LATE',1,0,NULL),

(1,1,'2025-10-16','2025-10-16 09:13:00','2025-10-16 18:29:00','LATE',1,0,NULL),
(1,2,'2025-10-16','2025-10-16 08:55:00','2025-10-16 18:10:00','ON_TIME',1,0,NULL),

(1,1,'2025-11-06','2025-11-06 08:57:00','2025-11-06 18:04:00','ON_TIME',1,0,NULL),
(1,2,'2025-11-06',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2025-11-20',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-11-20','2025-11-20 09:08:00','2025-11-20 18:26:00','LATE',1,0,NULL),

(1,1,'2025-12-04','2025-12-04 08:52:00','2025-12-04 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2025-12-04','2025-12-04 08:55:00','2025-12-04 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2025-12-18',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2025-12-18','2025-12-18 09:11:00','2025-12-18 18:33:00','LATE',1,0,NULL),

-- =========================
-- 2026 (총 30건 = 15일 * 2명)
-- =========================
(1,1,'2026-01-05','2026-01-05 08:55:00','2026-01-05 18:05:00','ON_TIME',1,0,NULL),
(1,2,'2026-01-05','2026-01-05 09:10:00','2026-01-05 18:20:00','LATE',1,0,NULL),

(1,1,'2026-01-12',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2026-01-12','2026-01-12 08:52:00','2026-01-12 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2026-01-19','2026-01-19 09:05:00','2026-01-19 18:25:00','LATE',1,0,NULL),
(1,2,'2026-01-19',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2026-01-26','2026-01-26 08:50:00','2026-01-26 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2026-01-26','2026-01-26 08:55:00','2026-01-26 18:06:00','ON_TIME',1,0,NULL),

(1,1,'2026-02-02',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2026-02-02','2026-02-02 09:15:00','2026-02-02 18:30:00','LATE',1,0,NULL),

(1,1,'2026-02-09','2026-02-09 08:54:00','2026-02-09 18:05:00','ON_TIME',1,0,NULL),
(1,2,'2026-02-09',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2026-02-16','2026-02-16 09:08:00','2026-02-16 18:22:00','LATE',1,0,NULL),
(1,2,'2026-02-16','2026-02-16 08:52:00','2026-02-16 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2026-02-23','2026-02-23 08:48:00','2026-02-23 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2026-02-23','2026-02-23 09:12:00','2026-02-23 18:28:00','LATE',1,0,NULL),

(1,1,'2026-03-02',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2026-03-02','2026-03-02 08:50:00','2026-03-02 18:05:00','ON_TIME',1,0,NULL),

(1,1,'2026-03-09','2026-03-09 08:55:00','2026-03-09 18:10:00','ON_TIME',1,0,NULL),
(1,2,'2026-03-09',NULL,NULL,'ABSENT',1,0,NULL),

(1,1,'2026-03-16','2026-03-16 09:11:00','2026-03-16 18:27:00','LATE',1,0,NULL),
(1,2,'2026-03-16','2026-03-16 08:54:00','2026-03-16 18:08:00','ON_TIME',1,0,NULL),

(1,1,'2026-03-23','2026-03-23 08:47:00','2026-03-23 18:02:00','ON_TIME',1,0,NULL),
(1,2,'2026-03-23','2026-03-23 09:09:00','2026-03-23 18:24:00','LATE',1,0,NULL),

(1,1,'2026-03-30',NULL,NULL,'ABSENT',1,0,NULL),
(1,2,'2026-03-30','2026-03-30 08:58:00','2026-03-30 18:10:00','ON_TIME',1,0,NULL);
