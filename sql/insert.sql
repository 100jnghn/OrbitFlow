...
(company_id, name, position, description, resource_status_id, uploader_id)
VALUES
    (1, '중회의실 B', '본관 2층 203호', '12인 수용, TV 모니터 구비', 1, 1),
    (1, '중회의실 C', '본관 2층 204호', '팀 회의 전용, 원형 테이블', 1, 1),
    (1, '화상 회의실 2', '본관 5층 501호', '화상회의 전용 장비 구축', 1, 1),
    (1, '프로젝트 룸 Beta', '별관 3층 302호', '단기 TF팀 사용 공간', 2, 1),
    (1, '교육실 1', '본관 지하 1층', '사내 교육 및 세미나용', 1, 1),
    (1, '교육실 2', '본관 지하 2층', '신입사원 교육 전용', 1, 1),
    (1, '미팅 부스 A', '본관 6층', '2인용 미팅 부스', 1, 1),
    (1, '미팅 부스 B', '본관 6층', '전화 및 화상 미팅용', 1, 1),
    (1, '임원 회의실', '본관 9층', '임원 전용 회의 공간', 3, 1),
    (1, '아이디어 스튜디오', '별관 1층', '자유 토론 및 기획 공간', 1, 1);
...
-- =========================================================
INSERT INTO car
(company_id, number, name, driver_age, description, resource_status_id, file_id, uploader_id)
VALUES
    (1, '11가1111', 'K5', 26, '영업팀 공용 차량', 1, NULL, 1),
    (1, '22나2222', '쏘나타 DN8', 26, '외근 및 출장용', 1, NULL, 1),
    (1, '33다3333', '투싼 NX4', 26, '팀 단위 이동용', 1, NULL, 1),
    (1, '44라4444', '스포티지', 21, '근거리 업무용', 2, NULL, 1),
    (1, '55마5555', 'EV6', 21, '전기차 시범 운영', 1, NULL, 1),
    (1, '66바6666', '봉고3', 26, '물품 운반용 차량', 1, NULL, 1),
    (1, '77사7777', '스타렉스', 26, '대규모 인원 이동용', 2, NULL, 1),
    (1, '88아8888', '제네시스 GV70', 30, '임원 공용 SUV', 1, NULL, 1),
    (1, '99자9999', '코나 EV', 21, '친환경 차량', 1, NULL, 1),
    (1, '10차1010', 'BMW 520i', 30, '외부 VIP 미팅용', 3, NULL, 1);
...
-- =========================================================
INSERT INTO item
(company_id, item_category_id, name, description, resource_status_id, file_id, uploader_id)
VALUES
    (1, 3, 'MacBook Air 15 (M3)', '기획팀 지급용 노트북', 1, NULL, 1),
    (1, 3, 'MacBook Pro 14 (M3)', '개발팀 공용 테스트 장비', 1, NULL, 1),
    (1, 2, '삼성 스마트 모니터 M8', '회의실 공용 디스플레이', 1, NULL, 1),
    (1, 2, 'LG 듀얼업 모니터', '개발자 세로형 모니터', 1, NULL, 1),
    (1, 4, '윈도우 노트북 A', '단기 파견 인력 대여용', 2, NULL, 1),
    (1, 4, '윈도우 노트북 B', '외부 협력사 대여용', 3, NULL, 1),
    (1, 1, '후지 x100v', '스냅샷 촬영용', 1, NULL, 1),
    (1, 1, '캐논 550d', '영상 촬영용', 1, NULL, 1),
    (1, 2, '고성능 모니터', '진짜 좋음', 1, NULL, 1),
    (1, 3, 'LG 그램', '신규 입사자 지급용', 1, NULL, 1);
...
(company_id, name, position, description, resource_status_id, uploader_id)
VALUES
    (2, '전략 회의실', '글로벌 센터 501호', '임원 전용 회의실, 최고급 화상 장비', 1, 1),     -- AVAILABLE
    (2, '아이디어 랩', '글로벌 센터 3층 휴게공간', '전면 화이트보드 벽면, 자유로운 분위기', 1, 1), -- AVAILABLE
    (2, '세미나실 B', '글로벌 센터 지하 1층', '50인 수용 가능, 강연대 및 마이크 설비', 2, 1),  -- INSPECTION
    (2, '화상 미팅룸 1', '글로벌 센터 505호', '1인용 포커스 룸, 방음 부스', 1, 1),        -- AVAILABLE
    (2, '프로젝트 룸 Alpha', '글로벌 센터 401호', 'TF팀 전용 장기 대관실', 3, 1);         -- UNAVAILABLE
...
(company_id, number, name, driver_age, description, resource_status_id, file_id, uploader_id)
VALUES
    (2, '99호1111', '벤츠 E-Class', 30, 'CEO 의전 차량', 1, NULL, 1),                 -- AVAILABLE
    (2, '88하2222', '쏘렌토 MQ4', 26, '영업 1팀 공용 차량', 1, NULL, 1),              -- AVAILABLE
    (2, '77호3333', '레이 EV', 21, '근거리 문서 수발신 및 마트 장보기용', 2, NULL, 1), -- INSPECTION
    (2, '66하4444', '스타리아 라운지', 26, '공항 픽업 및 바이어 접대용 (7인승)', 1, NULL, 1), -- AVAILABLE
    (2, '55호5555', '테슬라 Model Y', 26, 'IT 사업부 테스트 및 업무용', 3, NULL, 1);  -- UNAVAILABLE
...
(company_id, item_category_id, name, description, resource_status_id, file_id, uploader_id)
VALUES
    (2, 5, 'iPad Pro 12.9 (6세대)', '디자인 시안 검토용 태블릿', 1, NULL, 1),
    (2, 6, 'Dell PowerEdge R750', '사내 테스트 서버, 전산실 B구역 위치', 1, NULL, 1),
    (2, 7, 'Sony Alpha 7 IV', '마케팅팀 유튜브 촬영용 카메라', 2, NULL, 1),
    (2, 8, '허먼밀러 에어론', '허리 디스크 환자 전용 의자 (신청 필요)', 3, NULL, 1),
    (2, 9, 'JetBrains All Products', '개발팀 공용 라이선스 계정', 1, NULL, 1);
