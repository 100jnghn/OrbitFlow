...
VALUES (1, '12가3456', '그랜저 GN7', 26, '임원 및 외부 미팅용 법인 차량', 1, NULL),        -- AVAILABLE
       (1, '78나9012', '카니발 하이리무진', 26, '팀 워크샵 및 다인원 이동용 (9인승)', 1, NULL),  -- AVAILABLE
       (1, '34다5678', '아반떼 CN7', 21, '근거리 업무 및 영업용 차량', 2, NULL),          -- INSPECTION
       (1, '90라1234', '제네시스 G80', 30, 'VIP 의전용, 사용 전 비서실 문의 필수', 3, NULL), -- UNAVAILABLE
       (1, '56마7890', '아이오닉 5', 21, '친환경 전기차, 충전 카드 차량 내 비치', 1, NULL);
-- AVAILABLE
